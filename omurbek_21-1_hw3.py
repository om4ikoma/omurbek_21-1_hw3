class Franction:
    ...
    def __add__(self, other):
        ...
        return Franction(numerator=chisl, denumerator=znam)
    ...
    def __mul__(self, other):
        ...
        self.numerator = chisl
        self.denumerator = znam
        return Franction(numerator=self.numerator, denumerator=self.denumerator)
...
a = Franction(int(num1[0]), int(num1[1]))
b = Franction(int(num2[0]), int(num2[1]))
